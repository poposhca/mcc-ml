...
print('FUNCION DE CIRCULOS')
centro=np.array([1,2])
def puntosCirculo( centro, npuntos, r, etiqueta):
	"""
	Esta funcion genera un conjunto de n puntos dentro de un circulo definido
	...
	Donde todos los puntos son asignados a la misma etiqueta ( + )
